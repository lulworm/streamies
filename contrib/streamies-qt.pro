...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/streamies-cli.cpp \
           src/streamies-tx.cpp \
           src/streamies.cpp \
           src/db.cpp \
           ...
           src/qt/streamies.cpp \
           src/qt/streamiesstrings.cpp \
...
RESOURCES += src/qt/streamies.qrc src/qt/streamies_locale.qrc

TRANSLATIONS += src/qt/locale/streamies_bg.ts \
                src/qt/locale/streamies_de.ts \
                src/qt/locale/streamies_en.ts \
                src/qt/locale/streamies_es.ts \
                src/qt/locale/streamies_fi.ts \
                src/qt/locale/streamies_fr.ts \
                src/qt/locale/streamies_it.ts \
                src/qt/locale/streamies_ja.ts \
                src/qt/locale/streamies_pl.ts \
                src/qt/locale/streamies_pt.ts \
                src/qt/locale/streamies_ru.ts \
                src/qt/locale/streamies_sk.ts \
                src/qt/locale/streamies_sv.ts \
                src/qt/locale/streamies_vi.ts \
                src/qt/locale/streamies_zh_CN.ts \
                src/qt/locale/streamies_zh_TW.ts
