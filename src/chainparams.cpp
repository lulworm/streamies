...
static Checkpoints::MapCheckpoints mapCheckpoints =
	...
	(0, uint256("0x0000004ea54a53ee922c4827329e5e56c25e9ae4754ead95ca05f6a0740d652c"))
	(1, uint256("0x000004a9cc979baca9f22a55dc77320c41d91dcf3551cf6c4a9e25a6e50c0f61"))
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("039f890c94b1fc77b9bf5e4db6b68db0a6aae8555acc241d924e2c4a9f4f6e5e60");
        nDefaultPort = 55297;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Streamies starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetSpacing = 1 * 60;  // Streamies: 1 minute
        nMaturity = 60;
        ...
        const char* pszTimestamp = "Streamies Official Release";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1578784481;
        genesis.nBits = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 3822245;
        ...
        strSporkKey = "039f890c94b1fc77b9bf5e4db6b68db0a6aae8555acc241d924e2c4a9f4f6e5e60";
        strSporkKeyOld = "039f890c94b1fc77b9bf5e4db6b68db0a6aae8555acc241d924e2c4a9f4f6e5e60";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetSpacing = 1 * 60;  // STRMS: 1 minute
        nLastPOWBlock = 200;
        nStreamiesBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nStreamiesBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet streamies addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet streamies script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet streamies BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet streamies BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet streamies BIP44 coin type is '1' (All coin's testnet default)
        ...
        nStartMasternodePayments = 1575598471;
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetSpacing = 1 * 60;        // STRMS: 1 minutes
